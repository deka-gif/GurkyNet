...
export const Button = ({ variant = 'primary', children, className = '', ...props }: ButtonProps) => {
  ...
  const variants = {
    primary: "bg-gradient-to-br from-primary-600 to-primary-900 hover:brightness-110 hover:shadow-xl hover:shadow-primary-900/35 text-white shadow-lg shadow-primary-900/30 transition-all duration-200",
