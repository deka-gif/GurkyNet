          ...
          {!activeId ? (
            ...
            <>
              ...
              <div className="p-3 border-t border-gray-100 flex flex-col gap-1.5">
                {isOwnerReadOnly && (
                  <p className="text-[11px] font-semibold text-gray-400">Mode lihat-saja (Owner)</p>
                )}
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-gray-200 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary-500/20 disabled:bg-gray-50 disabled:text-gray-400"
                  />
                  <button
                    type="button"
                    disabled={isOwnerReadOnly || sending || !draft.trim()}
                    onClick={() => void send()}
