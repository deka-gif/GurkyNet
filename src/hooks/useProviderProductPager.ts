...
/**
 * Web providers-first product loader (threshold 30 / page 20).
 * Mirror apps/mobile/src/hooks/useProviderProductPager.ts — do not edit mobile.
 */
export function useProviderProductPager() {
  ...
  const clientCanLoadMore = displayLimit != null && displayLimit < products.length;
